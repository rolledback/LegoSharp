...
namespace LegoSharp
{
    ...
    public class BrickColor : ValuesFilterValue
    {
        ...
        public static readonly BrickColor MediumLavendel2021 = new BrickColor("Medium Lavendel", "Medium Lavendel");
        ...
        public static readonly BrickColor SandBlue = new BrickColor("Sand Blue", "Sand Blue");
