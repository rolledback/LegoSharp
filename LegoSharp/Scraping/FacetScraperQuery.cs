...
namespace LegoSharp
{
    public class FacetScraperQuery<GraphQueryT, GraphQueryResultT> : IGraphQuery<IEnumerable<Facet>> where GraphQueryT : IGraphQuery<GraphQueryResultT>
    {
        ...
        public FacetScraperQuery(IGraphQuery<GraphQueryResultT> queryToScrape, IFacetExtractor<GraphQueryT> facetExtractor)
        {
