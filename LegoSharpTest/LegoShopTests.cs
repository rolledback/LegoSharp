...
{
    [TestClass]
    public class LegoShopTests
    {
        static LegoShopClient testClient;
        ...
        {
            testClient = new LegoShopClient(new LegoSession());
        }
        ...
        {
            testClient.getShoppingBasket();
        }

        [TestMethod]
        public void getCurrentShopper()
        {
            LegoShopper shopper = testClient.getCurrentShopper();
            Assert.IsNotNull(shopper);
            Assert.IsNull(shopper.username);
        ...
        {
            IProductSearch test = new ProductSearch();
            List<Product> results = testClient.searchForProducts(test);
